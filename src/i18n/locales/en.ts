...
const en: typeof de = {
  ...
  settings: {
    ...
    backup: {
      title: "Backup",
      body: "Your data lives on this device only. Export it as a JSON file regularly.",
      export: "Export data",
      exported: "Backup exported",
      exportError: "Export failed",
      choose: "Read a backup",
      notJson: "That is not a valid JSON file",
      invalid: "That file is not a valid backup",
      confirm: '"{{file}}" replaces all data on this device. Continue?',
      summary: "{{exercises}} exercises · {{sessions}} sessions · {{measurements}} measurements",
    ...
    units: {
      title: "Units",
      body: "Default for new exercises. Weights you already logged are never converted.",
    },
    calories: {
      title: "Calories",
      body: "Days below this value count as incomplete and drop out of the average.",
      label: "Threshold",
      unit: "kcal",
      less: "{{step}} kcal less",
      more: "{{step}} kcal more",
      hint: "Used from Phase 2 on, once calorie data exists.",
    },
    yazio: {
      title: "Yazio",
      body: "Automatic calorie and bodyweight import arrives in Phase 2.",
    },
  },
  common: {
