...
Phase 2 (Yazio): 6. **Calories vs. bodyweight** — rolling averages + TDEE back-calculation. 7. **Combined** — calories / bodyweight / strength as stacked panels sharing one time
...
- Optional: a short moving average may smooth the _displayed_ index line. This is display
